...
class Bazaar(models.Model):
    ...
    bazaar_image = models.ImageField(upload_to='image/bazaar/%Y/%m/%d')
    bazaar_state = models.ManyToManyField(State, related_name='bazaar_state')
    bazaar_district = models.ManyToManyField(District, related_name='bazaar_district')
    bazaar_city = models.ManyToManyField(City, related_name='bazaar_city')
    bazaar_added_date = models.DateTimeField(default=datetime.now, blank=True)
