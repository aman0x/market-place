...
class Vendor(models.Model):
    ...
    delivery_area_id = models.ForeignKey(
        Locality, related_name='delivery_area', on_delete=models.CASCADE)
...
class UserPayment(models.Model):
    ...
    payment_user = models.ForeignKey(
        Account, related_name='payment_account', on_delete=models.CASCADE)
