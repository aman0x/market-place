...
class Agent(models.Model):
    ...
    agent_landmark = models.CharField(
        max_length=100, default=None, blank=True, null=True)
    ...
    agent_assigned_state = models.ManyToManyField(
        State, related_name="agent_assigned_state")
    agent_assigned_city = models.ManyToManyField(
        City, related_name="agent_assigned_city")
    ...
    agent_adhar_front_image = models.ImageField(
        upload_to="image/agent/", null=True)
    agent_adhar_back_image = models.ImageField(
        upload_to="image/agent/", default=None, null=True)
    agent_pancard_image = models.ImageField(
        upload_to="image/agent/", default=None, null=True)
    agent_pancard_no = models.CharField(
    ...
    agent_status = models.CharField(
        max_length=20, choices=AGENT_STATUS, default="CREATED")
